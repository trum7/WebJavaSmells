              ...
              <div class="col-md-8 col-md-offset-2" style="margin-top: 30px">
                  <div class="panel panel-primary">
                      <div class="panel-heading">
                          <h3 class="panel-title">Delete Sample</h3>
                      </div>
                      <div class="panel-body">
                          <g:form class="form-horizontal" controller="muestra" action="eliminate">
                              <fieldset>
                                  <div class="form-group">
                                      <label for="inputName" class="col-lg-2 control-label">Name</label>
                                      <div  class="col-lg-10">
                                          <g:select id="nombre" name="nombre" from="${proyecto1.Solicitud.list().muestra}" optionKey="nombre" optionValue="nombre" required="" value="${usuarioInstance?.Muestra?.id}" class="many-to-one"/>
                                      </div>
                                  </div>                                   
                                  <div class="form-group">
                                      <div class="col-lg-10 col-lg-offset-2">
                                          <!-- Cancel button -->
                                          <a type="reset" class="btn btn-default" href="/Proyecto1/administrador/index">Cancel</a>
                                          <a class="btn btn-primary" data-toggle="modal"  data-target="#myModal">Delete</a>
                                      </div>
                                  </div>
                                  <!-- Pop up  -->
                                      ...
                                      <div class="modal-dialog modal-sm" role="document">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-body" style="text-align : center">
                                                  <div class="row">
                                                      <div class="col-md-12">
                                                          <h4>Do you want to delete the sample?</h4>
                                                      </div>
                                                      <div class="col-md-6">
