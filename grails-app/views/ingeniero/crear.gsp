              ...
              <div class="col-md-8 col-md-offset-2" style="margin-top: 30px">
                  <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                          <g:form url="[resource:personaInstance, action:'save']" class="form-horizontal">
                              <fieldset>
                                  ...
                                  <div class="form-group">
                                      <label for="inputDoc" class="col-lg-2 control-label">Documento</label>
                                      <div  class="col-lg-10">
                                          <input class="form-control" id="inputDoc" name="documento" placeholder="Documento" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputPhone" class="col-lg-2 control-label">Phone</label>
                                      <div  class="col-lg-10">
                                          <input class="form-control" id="inputPhone" name="telefono" placeholder="Phone" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputEmail" class="col-lg-2 control-label">Email</label>
                                      <div  class="col-lg-10">
                                          <input class="form-control" id="inputEmail" name="correo" placeholder="Email" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputAddress" class="col-lg-2 control-label">Address</label>
                                      <div class="col-lg-10">
                                          <input class="form-control" id="inputAddress" name="direccion" placeholder="Address" type="text">
                                      </div>
                                  </div>
                                  <br>
                                  <br>
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <textarea class="form-control" rows="3" id="textArea" name="inputDescription"></textarea>
                                      </div>
                                  </div>
                                  <div class="form-group">
