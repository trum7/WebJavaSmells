		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="acceso" title="${message(code: 'usuario.acceso.label', default: 'Acceso')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${usuarioInstance.id}">${fieldValue(bean: usuarioInstance, field: "password")}</g:link></td>
					
						<td>${fieldValue(bean: usuarioInstance, field: "acceso")}</td>
