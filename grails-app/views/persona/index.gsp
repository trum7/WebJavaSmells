		...
		<div id="list-persona" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="documento" title="${message(code: 'persona.documento.label', default: 'Documento')}" />
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${personaInstance.id}">${fieldValue(bean: personaInstance, field: "correo")}</g:link></td>
