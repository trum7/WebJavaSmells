            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" style="padding-bottom : 0px">
                        <li><a href="/Proyecto1/cliente/home"><span class=" glyphicon glyphicon-home" style="font-size: 24px;"></span></a></li>
      ...
      <div class="container">
          <div class"row">
              <div class="col-md-4" style="margin-top : 80px; text-align:center">
                      ...
                      <div class="panel panel-danger">
                          ...
                          <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                              <div class="panel-body">
                                  ¡Welcome! You are now in the costumer panel, if you need help please contact us!
                              </div>
                          </div>
                      </div>
                      <div class="panel panel-danger">
                          ...
                          <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                              <div class="panel-body">
                                  Total of samples: ${ proyecto1.Muestra.findAllByCostumer( ( (proyecto1.Cliente.findByNombre( session.user ))) ).size( ) }
                              </div>
                          </div>
                      </div>
                      <div class="panel panel-danger">
                ...
                <div class="col-md-8" style="text-align: center; margin-top : 180px">
                     <div class="message">
   				        ${flash.message}
                     </div>
                     <div class="btn-group-vertical">
                            <a href="/Proyecto1/muestra/select" class="btn btn-primary btn-lg" style="margin : 40px; border-radius : 5px">Check generated report</a>    
                     </div>
                  </div>
              </div>
          </div>
