      ...
      <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Ingeniero</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" style="padding-bottom : 0px">
                        ...
                        <li><a href="#"><span class="glyphicon glyphicon-question-sign" style="font-size: 24px;"></span></a></li>
                        <li class="dropdown">
              ...
              <div class="col-md-8 col-md-offset-2" style="margin-top: 30px">
                  <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                          <g:form method="POST" controller="cliente" action="creation" class="form-horizontal">
                              <fieldset>
                                  ...
                                  <div class="form-group">
                                      <label for="inputDoc" class="col-lg-2 control-label">Rut</label>
                                      <div  class="col-lg-10">
                                          <input class="form-control" id="inputRut" name="rut" placeholder="Documento" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputCorreo" class="col-lg-2 control-label">Email</label>
                                      <div  class="col-lg-10">
                                          <input class="form-control" id="inputCorreo" name="correo" placeholder="Correo" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputDireccion" class="col-lg-2 control-label">Address</label>
                                      <div  class="col-lg-10">
                                          <input class="form-control" id="inputDireccion" name="direccion" placeholder="Direccion" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputTelefono" class="col-lg-2 control-label">Phone</label>
                                      <div class="col-lg-10">
                                          <input class="form-control" id="inputTelefono" name="telefono" placeholder="Telefono" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="inputPass" class="col-lg-2 control-label">Password</label>
                                      <div class="col-lg-10">
                                          <input class="form-control" id="inputPassword" name="password" placeholder="Password" type="text">
                                      </div>
                                  </div>
                                  <br>
                                  <br>
