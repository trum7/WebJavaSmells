...
class gsp_proyecto1_usuariodel_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/usuario/del.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',104,['class':("form-horizontal"),'method':("POST"),'controller':("usuario"),'action':("delet")],2)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1462042643091L
