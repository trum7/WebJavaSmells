...
class gsp_proyecto1_clientecrear_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/cliente/crear.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',137,['method':("POST"),'controller':("cliente"),'action':("creation"),'class':("form-horizontal")],2)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1462044754732L
