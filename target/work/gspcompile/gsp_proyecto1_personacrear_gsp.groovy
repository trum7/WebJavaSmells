...
class gsp_proyecto1_personacrear_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/persona/crear.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',128,['class':("form-horizontal"),'method':("POST"),'controller':("persona"),'action':("crear2")],2)
printHtmlPart(13)
...
public static final long LAST_MODIFIED = 1462046757217L
