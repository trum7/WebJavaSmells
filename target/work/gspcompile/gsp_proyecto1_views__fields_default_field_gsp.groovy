...
class gsp_proyecto1_views__fields_default_field_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/views/_fields/default/_field.gsp" }
public Object run() {
Writer out = getOut()
