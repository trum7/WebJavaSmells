...
class gsp_proyecto1_clientecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(clienteInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(clienteInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:clienteInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1461452821178L
