...
class gsp_proyecto1_clientehome_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/cliente/home.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
expressionOut.print(proyecto1.Muestra.findAllByCostumer( ( (proyecto1.Cliente.findByNombre( session.user ))) ).size( ))
printHtmlPart(12)
...
public static final long LAST_MODIFIED = 1462129005243L
